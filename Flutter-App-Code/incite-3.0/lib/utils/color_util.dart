...
static const Color textWhite = Color.fromRGBO(255, 255, 255,0.8);
...
//  primary1, primary2
// ]);
static const Color autoPlayRed = Color.fromRGBO(251, 14, 14, 1);
...
ColorFilter colorFilterMode(context,{Color? color}){
  return ColorFilter.mode( dark(context)? color ??  ColorUtil.white: color ?? ColorUtil.textblack, BlendMode.srcIn);
}
