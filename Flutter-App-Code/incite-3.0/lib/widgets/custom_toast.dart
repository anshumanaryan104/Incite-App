...
void showCustomToast(BuildContext context, String message,
    {String? text, VoidCallback? onTap, bool isSuccess = true, islogo = true}) {
...
void showPopUpCustomToast(BuildContext context, String message,
    {String? text, VoidCallback? onTap, bool isSuccess = true, islogo = true}) {
  OverlayEntry? overlayEntry;
  overlayEntry = OverlayEntry(
    builder: (BuildContext context) => Positioned(
...
class _CustomToastState extends State<CustomToast> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animationController = AnimationController(
        duration: const Duration(milliseconds: 200), vsync: this, lowerBound: 0.5, upperBound: 1.0);
          ...
          child: Container(
            ...
            child: GestureDetector(
              ...
              child: Material(
                ...
                shadowColor: ColorUtil.textblack.customOpacity(0.7),
                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      ...
                                      style: const TextStyle(
                                          fontSize: 13.0, fontWeight: FontWeight.w600, fontFamily: 'Roboto'),
                                    ),
                                  )),
                            ),
                      const SizedBox(width: 12),
