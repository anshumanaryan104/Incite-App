...
class _MotionLogoState extends State<MotionLogo> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animation =
        Tween<double>(begin: widget.decochild != null ? 0.5 : 0.0, end: 1.0).animate(_animationController);
    _animation2 =
        Tween<double>(begin: widget.decochild != null ? 0.94 : 0.85, end: 1.0).animate(_animationController);
  }
            ...
            child: Center(
                child: Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(widget.decochild != null ? 16 : 100.0),
                      border: Border.all(
                        color: Theme.of(context).primaryColor.customOpacity(0.7),
