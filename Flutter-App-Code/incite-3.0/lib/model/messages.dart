class Messages {
  ...
  String? bookmarkSave, bookmarkRemove, searchFieldEmpty, youHaveViewedAll, shorts;
  ...
  Messages(
      ...
      this.readLess,
      this.backToHome,
      this.assistantIsListening,
      this.cancelSearchSpeak,
      this.languageTranslatedTo,
      this.speakAgain,
      this.speakYourKeyword,
      this.system,
      this.dark,
      this.isRequired,
      this.light,
  ...
  Messages.fromJson(Map<String, dynamic> json) {
    ...
    noResultsFoundMatchingWithYourKeyword = json['app_no_results_found_matching_with_your_keyword'];
    ...
    passwordShouldBeMoreThanThereeCharacter = json['app_password_should_be_more_than_theree_character'];
    ...
    passwordAndConfirmPasswordShouldBeSame = json['app_password_and_confirm_password_should_be_same'];
    ...
    enableDisablePushNotification = json['app_enable_disable_push_notification'];
    ...
    readLess = json['read_less'];
    backToHome = json['back_to_home'];

    assistantIsListening = json['assistant_is_listening'];
    cancelSearchSpeak = json['cancel_search_speak'];
    speakAgain = json['speak_again'];
    speakYourKeyword = json['please_speak_your_keyword'];

    quotes = json['quotes'] ?? "Quotes";
    darkModeDescription = json['dark_mode_description'];
    system = json['system'];
    dark = json['dark'];
    light = json['light'];
    isRequired = json['is_required'];
    autoPlayAlert = json['auto_play_alert'];
    optional = json['optional'];

    languageTranslatedTo = json['language_translated_to'];
    swipeLeft = json['swipe_left'];
    swipeRight = json['swipe_right'];
    swipeUp = json['swipe_up'];
    swipeDown = json['swipe_down'];

    swipeLeft = json['swipe_left_text'];
    swipeRight = json['swipe_right_text'];
    swipeUp = json['swipe_up_text'];
    swipeDown = json['swipe_down_text'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['app_no_results_found_matching_with_your_keyword'] = noResultsFoundMatchingWithYourKeyword;
    ...
    data['filter_by_topics'] = filterByTopics;
    ...
    data['app_password_should_be_more_than_theree_character'] = passwordShouldBeMoreThanThereeCharacter;
    ...
    data['app_password_and_confirm_password_should_be_same'] = passwordAndConfirmPasswordShouldBeSame;
    ...
    data['app_enable_disable_push_notification'] = enableDisablePushNotification;
    ...
    data['read_less'] = readLess;
    data['back_to_home'] = backToHome;

    data['assistant_is_listening'] = assistantIsListening;
    data['cancel_search_speak'] = cancelSearchSpeak;
    data['speak_again'] = speakAgain;
    data['please_speak_your_keyword'] = speakYourKeyword;
    data['quotes'] = quotes;

    data['dark_mode_description'] = darkModeDescription;
    data['system'] = system;
    data['dark'] = dark;
    data['light'] = light;
    data['is_required'] = isRequired;
    data['auto_play_alert'] = autoPlayAlert;
    data['optional'] = optional;
    data['language_translated_to'] = languageTranslatedTo;

    data['swipe_down'] = swipeDown;
    data['swipe_up'] = swipeUp;
    data['swipe_left'] = swipeLeft;
    data['swipe_right'] = swipeRight;

    data['swipe_down_text'] = swipeDownText;
    data['swipe_up_text'] = swipeUpText;
    data['swipe_left_text'] = swipeLeftText;
    data['swipe_right_text'] = swipeRightText;
...
class ReceivedNotification {
  ...
  ReceivedNotification({this.id, this.title, this.payload, this.body});
