          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                model!.isToggle == true ? ToggleButton(isON: isOn, isNotification: true) : const SizedBox()
              ],
            ),
          ),
        ),
            ...
            child: Column(
              children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(widget.model!.title ?? 'Notification',
                              style: const TextStyle(
                                  fontFamily: 'Roboto', fontSize: 16, fontWeight: FontWeight.w600)),
                          const SizedBox(height: 4),
                          widget.model!.subtitle != null
                              ? Text(widget.model!.subtitle.toString(),
                                  style: const TextStyle(
                                    fontFamily: 'Roboto',
                                    fontSize: 12,
                                  ))
                    ...
                    widget.model!.isToggle == true
                        ? ToggleButton(
                            isON: appThemeModel.value.isNotificationEnabled.value, isNotification: true)
                        : const SizedBox()
                  ],
                ),
                ...
                SizedBox(
                  ...
                  child: Row(
                    children: [
                      Text(allMessages.value.fontA ?? 'A',
                          style: const TextStyle(
                      ...
                      Text(allMessages.value.fontA ?? 'A',
                          style: const TextStyle(
                              fontFamily: 'Roboto', fontSize: 32, fontWeight: FontWeight.w500)),
                    ],
                  ),
                ),
                ValueListenableBuilder(
                    ...
                    builder: (context, val, child) {
                      return Container(
                        ...
                        child: Text(
                            allMessages.value.fontDummyText ??
                                'This is the post body dolor sit amet, consecte vitae cursus elit bibendum.',
                            maxLines: 2,
                            style: TextStyle(fontFamily: 'Roboto', fontSize: val)),
                      );
                    })
              ],
            ),
