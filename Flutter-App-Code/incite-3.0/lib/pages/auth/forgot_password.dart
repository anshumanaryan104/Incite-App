  ...
  Widget build(BuildContext context) {
    ...
    return CustomLoader(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: Form(
            key: widget.isReset == true ? userprovider.resetFormKey : userprovider.forgetFormKey,
            child: Container(
              width: size.width,
                ...
                children: [
                    ...
                    children: [
                      InkResponse(
                        ...
                        child: const CircleAvatar(
                          ...
                          child:
                              Icon(Icons.keyboard_arrow_left_rounded, size: 28, color: ColorUtil.textblack),
                        ),
                      ),
                    ],
                  ),
                  ...
                  widget.isReset == true
                      ...
                      : TextFieldWidget(
                          ...
                          onValidate: (v) {
                            bool emailValid =
                                RegExp(r'^.+@[a-zA-Z]+\.{1}[a-zA-Z]+(\.{0,1}[a-zA-Z]+)$').hasMatch(v!);
                            if (v.isEmpty) {
                          ...
                          onFieldSubmitted: (p0) {
                            if (widget.isReset == false) {
                              ...
                              userprovider.forgetPassword(context, onChanged: (value) {
                                isLoad = false;
                                setState(() {});
                              });
                            }
                          ...
                          child: TextFieldWidget(
                            ...
                            suffix: InkResponse(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.symmetric(vertical: 0, horizontal: 17),
                                child: Icon(
                                  isObscure2 == false ? Icons.visibility_off : Icons.visibility,
                                  color: ColorUtil.textgrey2,
                                ),
                              ),
                            ),
                          ...
                          child: TextFieldWidget(
                            ...
                            suffix: InkResponse(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.symmetric(vertical: 0, horizontal: 17),
                                child: Icon(
                                  isObscure3 == false ? Icons.visibility_off : Icons.visibility,
                                  color: ColorUtil.textgrey2,
                                ),
                              ),
                            ),
