            ...
            children: [
              SingleChildScrollView(
                ...
                child: IntrinsicHeight(
                  child: Form(
                    autovalidateMode:
                        isSubmit ? AutovalidateMode.onUserInteraction : AutovalidateMode.disabled,
                          ...
                          onValidate: (v) {
                            if (v!.isEmpty) {
                              ...
                              return allMessages.value.enterAValidUserName ??
                                  'Name must contain 4 characters';
                            }
                            return null;
                          },
                          onSaved: (v) {
              ...
              const Positioned(
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Backbut()]),
              )
            ],
          ),
        ),
...
class AppIcon extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var color = isHandlerImage == true ? Colors.grey : null;
    var colorBlendMode = isHandlerImage == true ? BlendMode.saturation : null;
