...
import 'package:incite/widgets/dismiss_widget.dart';
...
class _LanguagePageState extends State<LanguagePage> {
  ...
  Widget build(BuildContext context) {
    var textStyle = const TextStyle(fontFamily: 'Roboto', fontSize: 30, fontWeight: FontWeight.w600);
                        ...
                        children: [
                          Padding(
                            ...
                            child: AnimationFadeSlide(
                              duration: 500,
                              dx: 0.3,
                              child: Text(allMessages.value.chooseYourLanguage ?? 'Choose your language',
                                  ...
                                  itemBuilder: (context1, index) {
                                    return RadiusBox(
                                        ...
                                        onTap: () {
                                          ...
                                          getLocalText(context);
                                          provider.getAnalyticData(isAds: true);
                                          provider.getAnalyticData(isAds: false).whenComplete(() {
                                            provider.getCategory().then((value) {
                                              ...
                                              showCustomToast(context,
                                                  '${allMessages.value.languageTranslatedTo} ${languageCode.value.name}');
