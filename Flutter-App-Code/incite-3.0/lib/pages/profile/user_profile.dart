...
class _UserProfileState extends State<UserProfile> {
  ...
  Future getImage() async {
    ...
    if (_image != null) {
      ...
      var multipartFile = http.MultipartFile('photo', stream, length, filename: _image!.path.split('/').last);
      ...
      await request.send().then((response) async {
        response.stream.transform(utf8.decoder).listen((value) async {
          ...
          setState(() {
            setCurrentUser(jsonDecode(value));
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFieldWidget(
                        ...
                        onSaved: (v) {
                          setState(() {
                            userProvider.user.phone = v!.split(' ').join('');
                          });
                          print(v);
                        },
                        length: 11,
                        onValidate: (p0) {
                          if (p0!.isNotEmpty && (p0.length < 7 || p0.length > 11)) {
                            isload = false;
                            setState(() {});
                        ...
                        lengthFormatter: [LengthLimitingTextInputFormatter(11), PhoneNumberInputFormatter()],
                        // textAction: TextInputAction.next,
                          ...
                          : ElevateButton(
                              ...
                              onTap: () {
                                Navigator.pushNamed(context, '/ResetPage',
                                    arguments: [false, currentUser.value.email]);
                              },
  ...
  Future<void> deleteAccount() async {
    ...
    try {
      ...
      if (data['success'] == true) {
        ...
        Navigator.of(context).pushNamedAndRemoveUntil('/LoginPage', (route) => false, arguments: false);
      } else {
        isload = false;
        setState(() {});
